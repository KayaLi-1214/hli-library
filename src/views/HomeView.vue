...
const hasWord = ref(false)
const validateFriend = (blur) => {
  if (formData.value.reason.includes('friend') && formData.value.reason.length > 9) {
    if (blur) hasWord.value = true
  } else {
    hasWord.value = false
  }
}
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="hasWord" style="color: green">Great to have a friend</div>
          </div>
          <div class="mb-3">
